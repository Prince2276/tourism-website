...
/**
 * Servlet implementation class UpdHotelServe
 */
@WebServlet("/UpdHotelServe")
public class UpdHotelServe extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect("UpdHotelInfo.jsp");
	}
